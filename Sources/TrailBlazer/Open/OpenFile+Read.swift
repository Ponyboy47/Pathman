...
public extension Readable {
    public func read(from offset: Offset = Offset(from: .current, bytes: 0), bytes byteCount: Int? = nil, encoding: String.Encoding = .utf8) throws -> String? {
...
extension Open: Readable where PathType == FilePath {
    public func read(from offset: Offset = Offset(from: .current, bytes: 0), bytes byteCount: Int? = nil) throws -> Data {
        try seek(offset)
