...
extension WritableByOpened where WriteReturnType == Void {
...
extension WritableByOpened where OpenOptionsType: DefaultWritableOpenOption, WriteReturnType == Void {
...
extension WritableByOpened where Self: SeekableByOpened, WriteReturnType == Void {
...
extension WritableByOpened where OpenOptionsType: DefaultWritableOpenOption, Self: SeekableByOpened, WriteReturnType == Void {
...
extension WritableByOpenedWithFlags where WriteReturnType == Void {
